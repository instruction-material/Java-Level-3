# DPR9 Testability, DI, and Refactoring with Confidence supplemental 2

Course: Design Patterns in Java Part 2: Refactoring
Module: DPR9 Testability, DI, and Refactoring with Confidence supplemental 2
...
Quick run hint: `javac Main.java && java Main`
